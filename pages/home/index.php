...
<body>
    <div class="box" id="box">
        ...
        <div class="music-box">
            <div id="dialog-heart" class="dialog" style="display: none">
                <div class="dialog-content">
                <span class="close" id="close-dialog-heart" style="width: 30px; height: 30px; z-index: 2;">
                    ...
                    <img src="../../public/img/video-ezgif.com-video-to-gif-converter.gif" style="width: 100%; height: 100%">
                </div>
            </div>
            <iframe
                    id="iframe"
            ...
            <div id="box-players" style="position: relative; top: -10px; width: 100%; justify-content: center; align-items: center; display: flex">
        ...
        <div style="flex-direction: row; margin-top: 5px; margin-bottom: 0; height: auto; justify-content: center; align-items: center;">
...
<!--            </section>-->
        ...
        <div style="justify-content: center; align-items: center">
            <div class="circle" id="button-movie-list">
                ...
                <form action="../../index.php" method="post" id="movie-list-form" style="display: none">
                    <input type="hidden" name="routes" value="movie/list"> <!-- name is attribute value for change the route -->
                </form>
            </div>
            <div class="circle" id="button-movie-recommendations">
                <div class="secundary-circle">
                ...
                <form action="../../index.php" method="post" id="movie-recommendation-form" style="display: none">
                    <input type="hidden" name="routes" value="movie/recommendations"> <!-- name is attribute value for change the route -->
                </form>
            </div>
            <div class="circle" id="button-heart">
                <div class="secundary-circle">
